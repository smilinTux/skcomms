...
def test_propose_logs_definition_for_audit():
    ...
    assert any("Q1" in line and "the open question" in line for line in neg.audit_log)
...
def test_two_agents_converge_a_private_macro():
    ...
    assert (
        a.macros.expand("noroc") == ".158 host noroc2027"
        or a.macros.expand("noroc") == "the .158 host noroc2027"
    )
